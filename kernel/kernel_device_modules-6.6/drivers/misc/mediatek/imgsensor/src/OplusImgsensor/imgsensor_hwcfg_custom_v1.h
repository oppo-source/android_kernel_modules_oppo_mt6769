...
struct IMGSENSOR_INIT_FUNC_LIST *Oplusimgsensor_Sensorlist(void);
...
extern struct IMGSENSOR_INIT_FUNC_LIST *oplus_imgsensor_sensor_list;
...
void oplus_imgsensor_set_mclkcurrent(MUINT32 *mclk_current);
#endif

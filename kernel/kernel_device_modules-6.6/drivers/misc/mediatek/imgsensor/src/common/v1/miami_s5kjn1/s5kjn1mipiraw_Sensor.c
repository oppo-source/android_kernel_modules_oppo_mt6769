...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MIAMI_S5KJN1_SENSOR_ID ,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	{4080, 3072,  0, 0, 4080, 3072, 2040, 1536, 0, 0, 2040, 1536, 0, 0, 2040, 1536}, /* Preview*/
	...
	{4080, 3072,  120, 456, 3840, 2160, 1280, 720, 0, 0, 1280, 720, 0, 0, 1280, 720}, /* slim video */
	{4080, 3072,  0, 0, 4080, 3072, 4080, 3072, 0, 0, 4080, 3072, 0, 0, 4080, 3072}, /* custom1 */
	{4080, 3072,  0, 0, 4080, 3072, 2040, 1536, 0, 0, 2040, 1536, 0, 0, 2040, 1536}, /* custom2 */
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.i4SubBlkW =  8,
	.i4SubBlkH =  2,
	.i4PosL = {{10, 8},{8, 11},{12, 12},{14, 15}},
	.i4PosR = {{11, 8},{9, 11},{13, 12},{15, 15}},
	.i4BlockNumX = 508,
	.i4BlockNumY = 382,
	.iMirrorFlip = 0,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_4080_3072_custom1 =
{
	.i4OffsetX =  8,
	.i4OffsetY =  8,
	.i4PitchX  =  8,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_3264_2448_custom2 =
{
	...
	.i4SubBlkW = 8,
	.i4SubBlkH = 2,
	.i4PosL = {{1, 8},{3, 11},{7, 12},{5, 15}},
	.i4PosR = {{0, 8},{2, 11},{6, 12},{4, 15}},
	.i4BlockNumX = 408,
	.i4BlockNumY = 304,
	.i4LeFirst = 0,
	.iMirrorFlip = 0,
...
static void read_s5kjn1_QRSerialdata(UINT8 *read_s5kjn1_QRSerialdata,
	UINT32 *feature_para_len)
{
	...
	for(i = 0; i < 17; i++){
		read_s5kjn1_QRSerialdata[i] = (kal_int8)read_cmos_sensor_shinetech_otp(start_addr + i);
		checksum = checksum + read_s5kjn1_QRSerialdata[i];
	}
	checksum = checksum % 255;
	if(read_cmos_sensor_shinetech_otp(start_addr+17) == 1 && read_cmos_sensor_shinetech_otp(start_addr+18) == checksum ) {
		*feature_para_len = i;
		LOG_INF("s5kjn1_sn checksum sucess, feature_para_len；%d", *feature_para_len);
	} else {
		*feature_para_len = 0;
		LOG_INF("s5kjn1_sn checksum failed");
	}
}
*/
#if 0
...
static void read_eepromData(void)
{
	...
	for (idx = 0; idx <DUALCAM_CALI_DATA_LENGTH; idx++) {
		CAM_DUAL_DATA[idx] = read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR + idx);
	}
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == S5KJN1_SENSOR_ID) && (data_length == DUALCAM_CALI_DATA_LENGTH)
			&& (data_base == S5KJN1_STEREO_START_ADDR)) {
			...
			write_eeprom_protect(1);
			msleep(6);
			LOG_INF("com_0:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR));
			LOG_INF("com_39:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+39));
			LOG_INF("innal_40:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+40));
			LOG_INF("innal_1556:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+1556));
			LOG_INF("tail1_1557:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+1557));
			LOG_INF("tail2_1558:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+1558));
			LOG_INF("tail3_1559:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+1559));
			LOG_INF("tail4_1560:0x%x\n", read_cmos_eeprom_8(S5KJN1_STEREO_START_ADDR+1560));
...
static void s5kjn1_set_lsc_reg_setting(
...
static kal_uint16 s5kjn1_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_hs_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 s5kjn1_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(s5kjn1_preview_setting,
		sizeof(s5kjn1_preview_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(s5kjn1_normal_video_setting,
		sizeof(s5kjn1_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(s5kjn1_hs_video_setting,
		sizeof(s5kjn1_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(s5kjn1_slim_video_setting,
		sizeof(s5kjn1_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	table_write_cmos_sensor(s5kjn1_custom1_setting,
		sizeof(s5kjn1_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	LOG_INF("%s CUS1_16M_24_FPS E! currefps\n", __func__);
	/*************MIPI output setting************/
	table_write_cmos_sensor(s5kjn1_custom2_setting,
		sizeof(s5kjn1_custom2_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
			...
			if (*sensor_id == 0x38e1) {
			    *sensor_id = imgsensor_info.sensor_id;
				...
				if(deviceInfo_register_value == 0x00){
					register_imgsensor_deviceinfo("Cam_r0", DEVICE_VERSION_S5KJN1,
									imgsensor_info.module_id);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			break;
		case MSDK_SCENARIO_ID_CUSTOM1:
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_4080_3072_custom1, sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		case MSDK_SCENARIO_ID_CUSTOM2:
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
	{
		...
		s5kjn1_set_lsc_reg_setting(index, feature_data_16,
					  (*feature_para_len)/sizeof(UINT16));
	}
		break;
	/*case SENSOR_FEATURE_GET_SERIANO_IC:
		read_s5kjn1_QRSerialdata(feature_data_8, feature_para_len);

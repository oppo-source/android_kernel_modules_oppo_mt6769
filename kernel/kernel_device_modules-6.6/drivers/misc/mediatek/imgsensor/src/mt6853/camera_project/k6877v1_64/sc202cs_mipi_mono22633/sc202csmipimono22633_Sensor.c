...
#include "sc202csmipimono22633_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_mono"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC202CS_SENSOR_ID22633,
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_MONO,    //ADD,2021/8/26,fix depth sc202cs output_dataformat
...
static void sensor_init(void)
{
  ...
  //write_cmos_sensor(0x3221,0x66); //mirror and flip = 0x66, mirror only = 0x06, flip only = 0x60, normal mode = 0x00;
}/* sensor_init  */
...
/*		 if (is_project(22633) || is_project(22712) || is_project(22713) ){
        ...
        *sensor_id = (return_sensor_id() + 1) ;
        ...
        LOG_INF("write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
        retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
UINT32 SC202CS_MIPI_MONO22633_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SC202CS_MIPI_MONO_SensorInit    */

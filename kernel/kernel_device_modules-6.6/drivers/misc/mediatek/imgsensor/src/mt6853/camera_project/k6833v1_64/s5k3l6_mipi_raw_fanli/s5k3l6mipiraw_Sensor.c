...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6_SENSOR_ID_FANLI,
			...
			if (*sensor_id == S5K3L6_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if(deviceInfo_register_value == 0x00){
					Eeprom_DataInit(0, S5K3L6_SENSOR_ID_FANLI);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
		...
		LOG_INF("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO scenarioId:%lld :%u\n", *feature_data, *(MUINT32 *)(uintptr_t)(*(feature_data + 1)));
        break;
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		    ...
		    LOG_INF("SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO scenarioId:%lld :%u\n", *feature_data, *(MUINT32 *)(uintptr_t)(*(feature_data + 1)));
            break;
...
UINT32 S5K3L6_MIPI_RAW_FANLI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

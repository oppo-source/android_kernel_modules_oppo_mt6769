...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV16A1Q_SENSOR_ID_HAWAII,
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
static BYTE ov16a1q_hawaii_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };
static kal_uint16 read_ov16a1q_hawaii_eeprom_module(kal_uint32 addr)
{
    kal_uint16 get_byte = 0;
    char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
static void read_ov16a1q_hawaii_module_data(UINT32 sensor_id)
{
// ov16a1q_hawaii_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
    ...
    memset(ov16a1q_hawaii_common_data, 0,sizeof(ov16a1q_hawaii_common_data));
    // QR
    for(idx = 0; idx < sn_length; idx++)
    {
        ov16a1q_hawaii_common_data[8 + idx] = read_ov16a1q_hawaii_eeprom_module(sn_starAddr + idx);
    }
    //vcm
    ov16a1q_hawaii_common_data[40] = read_ov16a1q_hawaii_eeprom_module(vcmAddr);
    ov16a1q_hawaii_common_data[41] = read_ov16a1q_hawaii_eeprom_module(vcmAddr + 1);
    //lensid
    ov16a1q_hawaii_common_data[44] = read_ov16a1q_hawaii_eeprom_module(lensAddr);
    ov16a1q_hawaii_common_data[45] = read_ov16a1q_hawaii_eeprom_module(lensAddr + 1);
    //sensor id
    ov16a1q_hawaii_common_data[30] = ((sensor_id) >> 24) & 0xff;
    ov16a1q_hawaii_common_data[31] = ((sensor_id) >> 16) & 0xff;
    ov16a1q_hawaii_common_data[32] = ((sensor_id) >> 8) & 0xff;
    ov16a1q_hawaii_common_data[33] = (sensor_id) & 0xff;

    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
        LOG_INF("cam data: %02x %02x %02x %02x\n",
               ov16a1q_hawaii_common_data[idx],
               ov16a1q_hawaii_common_data[idx + 1],
               ov16a1q_hawaii_common_data[idx + 2],
               ov16a1q_hawaii_common_data[idx + 3]);
}
        ...
        do {
            *sensor_id = ((read_cmos_sensor(0x300B) << 8)
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                module_id = read_ov16a1q_hawaii_eeprom_module(MODULE_ID_OFFSET);

                if(deviceInfo_register_value == 0x00){
                        Eeprom_DataInit(1, OV16A1Q_SENSOR_ID_HAWAII);
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
                read_ov16a1q_hawaii_module_data(*sensor_id);
//#endif  /* OPLUS_FEATURE_CAMERA_COMMON */
                return ERROR_NONE;
            }
...
//lizhihui@vanyol.com,2022/05/31, add featurecontrol
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, ov16a1q_hawaii_common_data,

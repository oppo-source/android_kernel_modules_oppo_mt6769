...
#include "ova0b4mipiraw22633_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OVA0B4_SENSOR_ID22633,
    ...
    .mipi_sensor_type = MIPI_CPHY,//MIPI_OPHY_NCSI2,//MIPI_CPHY,
    .mipi_settle_delay_mode = 0,
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_B,
    .mclk = 24, /* mclk value, suggest 24 or 26 for 24Mhz or 26Mhz */
    .mipi_lane_num = SENSOR_MIPI_3_LANE,//SENSOR_MIPI_4_LANE,//SENSOR_MIPI_3_LANE,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[12] = {
    ...
    { 11584, 8688,    0, 1086, 11584, 6516,  4000, 2256,    0,    0,  4000, 2256, 0,   0,   4000, 2256},// custom2
    { 11584, 8688,    0,    0, 11584, 8688, 11584, 8688,    0,    0, 11584, 8688, 0,   0,  11584, 8688},// custom3
    { 11584, 8688,    0,    0, 11584, 8688,  5792, 4344,    0,    0,  5792, 4344, 0,   0,   5792, 4344},// custom4
    ...
    { 11584, 8688,   32, 1104, 11520, 6480,  2880, 1620,    0,    0,  2880, 1620, 0,   0,   2880, 1620},// custom7
};

static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[12] = {
    ...
    /* normal_video mode setting */
    {
        ...
        0x01, 0x2B, 0x02d0, 0x065c, 0x03, 0x00, 0x0000, 0x0000
    },
    ...
    /* slim_video mode setting */
    {
        0x02, 0x0a, 0x0000, 0x0008, 0x40, 0x00,
        0x00, 0x2b, 0x0b40, 0x0654, 0x00, 0x00, 0x0000, 0x0000,
        0x01, 0x2b, 0x02d0, 0x0670, 0x03, 0x00, 0x0000, 0x0000
    },
    ...
    /* custom2 mode setting */
    {
        0x02, 0x0a, 0x0000, 0x0008, 0x40, 0x00,
        0x00, 0x2b, 0x0FA0, 0x08d0, 0x00, 0x00, 0x0000, 0x0000,
        0x01, 0x2b, 0x02d0, 0x0660, 0x03, 0x00, 0x0000, 0x0000
    },
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_video_4000 = {
    .i4OffsetX = 16,
    .i4OffsetY = 4,
    .i4PitchX = 16,
    .i4PitchY = 16,
...
static BYTE ova0b4_22633_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_ova0b4_22633_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
	iReadRegI2CTiming(pusendcmd, 2, (u8 *) &get_byte, 1, EEPROM_I2C_ADDR, imgsensor_info.i2c_speed);
	return get_byte;
}

static void read_ova0b4_22633_module_data(UINT32 sensor_id)
{
// ova0b4_22633_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
...
// sensorid : [30 ~ 33]
	...
	memset(ova0b4_22633_common_data, 0,sizeof(ova0b4_22633_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ova0b4_22633_common_data[8 + idx] = read_ova0b4_22633_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	ova0b4_22633_common_data[40] = read_ova0b4_22633_eeprom_module(vcmAddr);
	ova0b4_22633_common_data[41] = read_ova0b4_22633_eeprom_module(vcmAddr + 1);
	//lensid
	ova0b4_22633_common_data[44] = read_ova0b4_22633_eeprom_module(lensAddr);
	ova0b4_22633_common_data[45] = read_ova0b4_22633_eeprom_module(lensAddr + 1);
	//macro
	ova0b4_22633_common_data[48] = read_ova0b4_22633_eeprom_module(macAddr_lsb);
	ova0b4_22633_common_data[49] = read_ova0b4_22633_eeprom_module(macAddr_msb);
	//inf
	ova0b4_22633_common_data[52] = read_ova0b4_22633_eeprom_module(infAddr_lsb);
	ova0b4_22633_common_data[53] = read_ova0b4_22633_eeprom_module(infAddr_msb);
	//sensor id
	ova0b4_22633_common_data[30] = ((sensor_id) >> 24) & 0xff;
	ova0b4_22633_common_data[31] = ((sensor_id) >> 16) & 0xff;
	ova0b4_22633_common_data[32] = ((sensor_id) >> 8) & 0xff;
	ova0b4_22633_common_data[33] = (sensor_id) & 0xff;

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
	{
		pr_debug("cam data: %02x %02x %02x %02x\n",
		       ova0b4_22633_common_data[idx],
		       ova0b4_22633_common_data[idx + 1],
		       ova0b4_22633_common_data[idx + 2],
		       ova0b4_22633_common_data[idx + 3]);
	}
}

static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    //pr_debug("my_add_log4:get_imgsensor_id_begin");
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
	printk("ova0b4 get_imgsensor_id----1  0x%x\n",imgsensor_info.sensor_id);
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor(0x300B) << 8)
			...
			printk("ova0b4 get_imgsensor_id----2  0x%x\n",*sensor_id);
            if (*sensor_id == 0xa042) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                read_ova0b4_22633_module_data(*sensor_id);
                return ERROR_NONE;
            }
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    imgsensor.current_fps = imgsensor_info.custom7.max_framerate;
    imgsensor.dummy_line = 0;
    imgsensor.dummy_pixel = 0;
    imgsensor.autoflicker_en = KAL_FALSE;
    spin_unlock(&imgsensor_drv_lock);
    load_custom7_setting();
    set_mirror_flip(imgsensor.mirror);
    pr_debug("OVA0B40MIPIRAW %s X\n", __func__);
    return ERROR_NONE;
} /* custom7 */
    ...
    UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_CHECK_SENSOR_ID:
        pr_debug("my_add_log5:case SENSOR_FEATURE_CHECK_SENSOR_ID:");
...
/***********************************************************************************************************************/
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            ...
            break;
        case MSDK_SCENARIO_ID_CUSTOM6:
            memcpy((void *)PDAFinfo,(void *)&imgsensor_pd_info_video_4000,sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_CUSTOM7:
            memcpy((void *)PDAFinfo,(void *)&imgsensor_pd_info_video_4000,sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
...
//jixinji@vanyol.com,2022/08/24, add featurecontrol
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ova0b4_22633_common_data,

...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6_SENSOR_ID_LIJING,
			...
			if (*sensor_id == S5K3L6_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if(deviceInfo_register_value == 0x00){
					Eeprom_DataInit(0, S5K3L6_SENSOR_ID_LIJING);
...
UINT32 S5K3L6_MIPI_RAW_LIJING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

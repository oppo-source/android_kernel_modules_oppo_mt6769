...
#define PFX "lijing s5kjn103_camera_sensor"
#define LOG_1 LOG_INF("lijing s5kjn103,MIPI 4LANE\n")
/****************************   Modify end	**************************/
...
#define DEVICE_VERSION_S5KJN103	 "s5kjn103_mipi_raw_lijing"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN103_SENSOR_ID_LIJING,
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == S5KJN103_SENSOR_ID_LIJING) && (data_length == DUALCAM_CALI_DATA_LENGTH)
...
static void sensor_init(void)
{
	...
	/*S5KJN1SQ_EVT0_ReferenceSetfile_v0.4h_20220208*/
			...
			if (*sensor_id == S5KJN103_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if(deviceInfo_register_value == 0x00){
					ret = Eeprom_DataInit(0, S5KJN103_SENSOR_ID_LIJING);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable)
	{
		write_cmos_sensor(0x0602, 0x0000); /*100% Color bar*/
...
UINT32 S5KJN103_MIPI_RAW_LIJING_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6_SENSOR_ID_LIJINGA,
...
static kal_uint16 addr_data_pair_init_s5k3l6[] = {
	0x0A02, 0x3400,
	0x3084, 0x1314,
	0x3266, 0x0001,
	0x3242, 0x2020,
...
static kal_uint16 addr_data_pair_preview_s5k3l6[] = {
0x0344, 0x0020,
0x0346, 0x0008,
0x0348, 0x105F,
0x034A, 0x0C37,
...
static kal_uint16 addr_data_pair_capture30_s5k3l6[] = {
0x0344, 0x0020,
0x0346, 0x0008,
0x0348, 0x105F,
0x034A, 0x0C37,
...
static kal_uint16 addr_data_pair_video_s5k3l6[] = {
0x0344, 0x0020,
0x0346, 0x018E,
0x0348, 0x105F,
0x034A, 0x0AB1,
...
static kal_uint16 addr_data_pair_hs_video_s5k3l6[] = {
0x0344, 0x0340,
0x0346, 0x0350,
0x0348, 0x0D3F,
0x034A, 0x08EF,
...
static kal_uint16 addr_data_pair_slim_video_s5k3l6[] = {
0x0344, 0x00C0,
0x0346, 0x01E8,
0x0348, 0x0FBF,
0x034A, 0x0A57,
...
static kal_uint16 addr_data_pair_custom1_s5k3l6[] = {
0x0344, 0x0020,
0x0346, 0x0008,
0x0348, 0x105F,
0x034A, 0x0C37,
...
static kal_uint16 addr_data_pair_custom2_s5k3l6[] = {
0x0344, 0x0008,
0x0346, 0x0008,
0x0348, 0x1077,
0x034A, 0x0C37,
...
static kal_uint16 addr_data_pair_custom3_s5k3l6[] = {
0x0344, 0x0028,
0x0346, 0x01A0,
0x0348, 0x1027,
0x034A, 0x0A9F,
...
static void custom3_setting(void)
{
	LOG_INF("%s enter\n",__func__);
	s5k3l6_table_write_cmos_sensor(
		addr_data_pair_custom3_s5k3l6,
		sizeof(addr_data_pair_custom3_s5k3l6) / sizeof(kal_uint16));
}

static kal_uint16 addr_data_pair_custom4_s5k3l6[] = {
0x0344, 0x0070,
0x0346, 0x0044,
0x0348, 0x100F,
0x034A, 0x0BFB,
...
static void custom4_setting(void)
{
	LOG_INF("%s enter\n",__func__);
	s5k3l6_table_write_cmos_sensor(
		addr_data_pair_custom4_s5k3l6,
		sizeof(addr_data_pair_custom4_s5k3l6) / sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == S5K3L6_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				if(deviceInfo_register_value == 0x00){
					Eeprom_DataInit(0, S5K3L6_SENSOR_ID_LIJINGA);
...
static kal_uint32 set_test_pattern_mode(kal_uint8 modes, struct SET_SENSOR_PATTERN_SOLID_COLOR *pTestpatterndata)
{
	...
	if (modes) {
		...
		if (modes == 1) { //Solid Color
			...
			write_cmos_sensor_16_8(0x0601, 0x1);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PIXEL_RATE:
			...
			LOG_INF("SENSOR_FEATURE_GET_PIXEL_RATE :%u\n", *(MUINT32 *)(uintptr_t)(*(feature_data + 1)));
		break;
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
		...
		LOG_INF("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO scenarioId:%llu :%u\n", *feature_data, *(MUINT32 *)(uintptr_t)(*(feature_data + 1)));
        break;
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		    ...
		    LOG_INF("SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO scenarioId:%llu :%u\n", *feature_data, *(MUINT32 *)(uintptr_t)(*(feature_data + 1)));
            break;
...
UINT32 S5K3L6_MIPI_RAW_LIJINGA_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

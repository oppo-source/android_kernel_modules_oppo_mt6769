...
#define sc6607_24700_NAME	"flashlights_orisc"
...
/* 	rval = sc6607_24700_pinctrl_init(flash);
	...
	rval = sc6607_24700_subdev_init(flash, sc6607_24700_LED0, "flashlights_orisc-led0");
	if (rval < 0)
		return rval;

/* 	rval = sc6607_24700_subdev_init(flash, sc6607_24700_LED1, "flashlights_orisc-led1");
	if (rval < 0)
		return rval; */
...
static int sc6607_24700_remove(struct i2c_client *client)
{
...
static const struct of_device_id sc6607_24700_of_table[] = {
	{ .compatible = "mediatek,flashlights_orisc" },
	{ },
};
...
MODULE_AUTHOR("XXX");
MODULE_DESCRIPTION("flashlights_orisc LED flash v4l2 driver");
MODULE_LICENSE("GPL");

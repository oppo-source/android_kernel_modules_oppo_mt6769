...
/*
 * Copyright(C)2014 OPLUS Mobile Comm Corp.
...
#define SENSOR_TYPE_BACK_TAP_DETECT                    86
#define SENSOR_TYPE_PALM_DETECT                        88
#define SENSOR_TYPE_REAR_ALS                           98
#define SENSOR_TYPE_REAR_CCT                           99
#define SENSOR_TYPE_REAR_FLICKER                       100
...
#define ID_PALM_DETECT          (ID_OPLUS_BASE + SENSOR_TYPE_PALM_DETECT - 1)
#define ID_CCT                  (ID_OPLUS_BASE+SENSOR_TYPE_CCT - 1)
#define ID_REAR_ALS             (ID_OPLUS_BASE+SENSOR_TYPE_REAR_ALS - 1)
#define ID_REAR_CCT             (ID_OPLUS_BASE+SENSOR_TYPE_REAR_CCT - 1)

...
/*
 * DW9800SAF voice coil motor driver
 *
 *
 */
...
#if 0
static int s4DW9800SAF_ReadReg(unsigned short *a_pu2Result)
{
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		/* soft power on */
        /* Shipei.Chen@Cam.Drv, 20200630, modify for DW9800SAF VCM Driver init*/
...
/* ////////////////////////////////////////////////////////////// */
long DW9800SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800SAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9800SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800SAF_GetFileName(unsigned char *pFileName)
{

...
#define MAX_NORMAL_BRIGHTNESS 3216
...
static bool aod_state = false;/*add aod*/
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xC9, 0x1C);
	...
	lcm_dcs_write_seq_static(ctx, 0x05, 0x77);
	...
	lcm_dcs_write_seq_static(ctx, 0x30, 0xFE);
	...
	lcm_dcs_write_seq_static(ctx, 0x45, 0xFE);
	...
	lcm_dcs_write_seq_static(ctx, 0x58, 0xE0);
	lcm_dcs_write_seq_static(ctx, 0x59, 0xDF);
	lcm_dcs_write_seq_static(ctx, 0x5A, 0xDF);
	lcm_dcs_write_seq_static(ctx, 0x5B, 0xDE);
	lcm_dcs_write_seq_static(ctx, 0x5C, 0xDD);
	lcm_dcs_write_seq_static(ctx, 0x5D, 0xD9);
	lcm_dcs_write_seq_static(ctx, 0x5E, 0xD9);
	lcm_dcs_write_seq_static(ctx, 0x5F, 0xD2);
	lcm_dcs_write_seq_static(ctx, 0x60, 0xD0);
	lcm_dcs_write_seq_static(ctx, 0x61, 0xCB);
	lcm_dcs_write_seq_static(ctx, 0x62, 0xC6);
	lcm_dcs_write_seq_static(ctx, 0x63, 0xC4);
	lcm_dcs_write_seq_static(ctx, 0x64, 0xBB);
	lcm_dcs_write_seq_static(ctx, 0x65, 0xB0);
	lcm_dcs_write_seq_static(ctx, 0x66, 0x94);
	lcm_dcs_write_seq_static(ctx, 0x67, 0x61);
	...
	lcm_dcs_write_seq_static(ctx, 0x02, 0x22);
	lcm_dcs_write_seq_static(ctx, 0x03, 0x22);
	lcm_dcs_write_seq_static(ctx, 0x04, 0x23);
	lcm_dcs_write_seq_static(ctx, 0x05, 0x23);
	lcm_dcs_write_seq_static(ctx, 0x06, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x07, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x08, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x09, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x0A, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x0B, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x0C, 0x0D);
	lcm_dcs_write_seq_static(ctx, 0x0D, 0x0E);
	lcm_dcs_write_seq_static(ctx, 0x0E, 0x0F);
	...
	lcm_dcs_write_seq_static(ctx, 0x16, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x17, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x18, 0x22);
	lcm_dcs_write_seq_static(ctx, 0x19, 0x22);
	lcm_dcs_write_seq_static(ctx, 0x1A, 0x23);
	lcm_dcs_write_seq_static(ctx, 0x1B, 0x23);
	lcm_dcs_write_seq_static(ctx, 0x1C, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x1D, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x1E, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x1F, 0x26);
	lcm_dcs_write_seq_static(ctx, 0x20, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x21, 0x0C);
	...
	lcm_dcs_write_seq_static(ctx, 0x27, 0x06);
	lcm_dcs_write_seq_static(ctx, 0x28, 0x05);
	lcm_dcs_write_seq_static(ctx, 0x29, 0x04);
	lcm_dcs_write_seq_static(ctx, 0x2F, 0x0E);
	lcm_dcs_write_seq_static(ctx, 0x30, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x31, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x33, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x34, 0x0E);
	lcm_dcs_write_seq_static(ctx, 0x35, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x37, 0x77);
	lcm_dcs_write_seq_static(ctx, 0x38, 0x74);
	lcm_dcs_write_seq_static(ctx, 0x3A, 0x46);
	lcm_dcs_write_seq_static(ctx, 0x3B, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0x50, 0x87);
	lcm_dcs_write_seq_static(ctx, 0x54, 0x78);
	lcm_dcs_write_seq_static(ctx, 0x55, 0x8B, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0x59, 0x60);
	lcm_dcs_write_seq_static(ctx, 0x5A, 0x46);
	lcm_dcs_write_seq_static(ctx, 0x5B, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0x5C, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x5D, 0x08);
	lcm_dcs_write_seq_static(ctx, 0x5E, 0x00, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x61, 0x44);
	lcm_dcs_write_seq_static(ctx, 0x6E, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x92, 0x61);
	lcm_dcs_write_seq_static(ctx, 0x93, 0x3D, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x94, 0x12);
	lcm_dcs_write_seq_static(ctx, 0xB1, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xC7, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xC8, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0xC9, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xCA, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0xDC, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x25);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x13, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x14, 0x27);
	lcm_dcs_write_seq_static(ctx, 0x16, 0xC0);
	lcm_dcs_write_seq_static(ctx, 0xCC, 0x11);
	lcm_dcs_write_seq_static(ctx, 0xCD, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x84);
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xD1, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xD2, 0xF4);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x26);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xCA, 0xC0);
	lcm_dcs_write_seq_static(ctx, 0x4D, 0x46);
	lcm_dcs_write_seq_static(ctx, 0x4E, 0x4B);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x27);
	lcm_dcs_write_seq_static(ctx, 0xFB, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x58, 0xAC);
	lcm_dcs_write_seq_static(ctx, 0x59, 0x00, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x5A, 0x00, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x5D, 0x00, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x5E, 0x01, 0x2F);
	lcm_dcs_write_seq_static(ctx, 0x5F, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x60, 0x06, 0x72);
	lcm_dcs_write_seq_static(ctx, 0x78, 0x86);
	lcm_dcs_write_seq_static(ctx, 0x79, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x7A, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x7C, 0x28);
	lcm_dcs_write_seq_static(ctx, 0x7D, 0x50);
	lcm_dcs_write_seq_static(ctx, 0x83, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0x84, 0x0D);
	lcm_dcs_write_seq_static(ctx, 0x85, 0x0B);
	lcm_dcs_write_seq_static(ctx, 0x87, 0x0D);
	lcm_dcs_write_seq_static(ctx, 0x88, 0x0F);
	lcm_dcs_write_seq_static(ctx, 0x89, 0x0B);
	...
	lcm_dcs_write_seq_static(ctx, 0x97, 0x16);
	lcm_dcs_write_seq_static(ctx, 0x98, 0x88);
	lcm_dcs_write_seq_static(ctx, 0x9B, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x9D, 0x35);
	lcm_dcs_write_seq_static(ctx, 0xA9, 0x3C);
	lcm_dcs_write_seq_static(ctx, 0xAD, 0x37);
	lcm_dcs_write_seq_static(ctx, 0xB4, 0x90);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x46);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0x46);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xC4, 0x46);
	lcm_dcs_write_seq_static(ctx, 0xC5, 0x4B);
	lcm_dcs_write_seq_static(ctx, 0xE5, 0x23);
	lcm_dcs_write_seq_static(ctx, 0xF4, 0xC8);
	...
	lcm_dcs_write_seq_static(ctx, 0x28, 0x3D);
	lcm_dcs_write_seq_static(ctx, 0x2A, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x2B, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x2D, 0x3D);
	lcm_dcs_write_seq_static(ctx, 0x64, 0x16);
	lcm_dcs_write_seq_static(ctx, 0x67, 0x16);
	lcm_dcs_write_seq_static(ctx, 0x6A, 0x16);
	lcm_dcs_write_seq_static(ctx, 0x73, 0x16);
	...
	lcm_dcs_write_seq_static(ctx, 0xA4, 0xFF);
	lcm_dcs_write_seq_static(ctx, 0xF3, 0x19);
	lcm_dcs_write_seq_static(ctx, 0xF6, 0x1A);
	...
	lcm_dcs_write_seq_static(ctx, 0x11, 0x00);
	usleep_range(101 * 1000,  101* 1010);
	lcm_dcs_write_seq_static(ctx, 0x29, 0x00);
	usleep_range(41 * 1000, 41 * 1010);
...
static int lcm_prepare(struct drm_panel *panel)
{
	...
	devm_gpiod_put(ctx->dev, ctx->bias_neg);
	usleep_range(12 * 1000, 12 * 1000+100);// 12ms
...
#define HAC (720)
#define VFP_90hz (936)
#define VFP_60hz (2256)
#define VFP_50hz (3032)
#define VFP_120hz (317)
...
static struct mtk_panel_params ext_params = {
    .vendor = "nt36528b_oris_a",
    .manufacture = "24713_txdhkc_nt36528b",
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	/* wanhang */
	register_device_proc("lcd", "nt36528b", "txdhkc");
	pr_info("%s- lcm,nt36528b_txdhkc,vdo,90hz\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus24713_nt36528b_txdhkc_hdp_dsi_vdo",
		.owner = THIS_MODULE,

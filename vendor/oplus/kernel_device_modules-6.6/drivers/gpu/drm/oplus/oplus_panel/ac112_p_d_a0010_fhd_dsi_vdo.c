...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x29, 0xC8);
	lcm_dcs_write_seq_static(ctx, 0x2D, 0xB7);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x18);
	...
	lcm_dcs_write_seq_static(ctx, 0x00, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x02, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x03, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x04, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x05, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x06, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x07, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x08, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0x09, 0x5C);
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x06);
	...
	lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x12);
	lcm_dcs_write_seq_static(ctx, 0x10, 0x14);
	...
	lcm_dcs_write_seq_static(ctx, 0x18, 0x5A);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[LCM] %s+ ac112_p_d_a0010_fhd_dsi_vdo_lcm_drv Start\n", __func__);
	...
	pr_info("ac112_p_d_a0010_fhd_dsi_vdo_lcm_drv End.\n");
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ac112_p_d_a0010_fhd_dsi_vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("ac112_p_d_a0010 panel drm driver");

...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x00, 0x49);
	lcm_dcs_write_seq_static(ctx, 0x01, 0x18);
	...
	lcm_dcs_write_seq_static(ctx, 0x24, 0xC5);
	lcm_dcs_write_seq_static(ctx, 0x25, 0x88);
	...
	lcm_dcs_write_seq_static(ctx, 0x0A, 0xF2);
	...
	lcm_dcs_write_seq_static(ctx, 0x16, 0x81);
	lcm_dcs_write_seq_static(ctx, 0x17, 0x0A);
	lcm_dcs_write_seq_static(ctx, 0x18, 0x72);
	...
	lcm_dcs_write_seq_static(ctx, 0x28, 0x8E);
	lcm_dcs_write_seq_static(ctx, 0x29, 0x5D);
	lcm_dcs_write_seq_static(ctx, 0xEF, 0x00);

	lcm_dcs_write_seq_static(ctx, 0x2A, 0x5B);
	lcm_dcs_write_seq_static(ctx, 0x2B, 0x8E);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x00);

	lcm_dcs_write_seq_static(ctx, 0x31, 0x07);
	lcm_dcs_write_seq_static(ctx, 0x32, 0x0D);
	...
	lcm_dcs_write_seq_static(ctx, 0x3D, 0x1F);
	lcm_dcs_write_seq_static(ctx, 0x3E, 0x1D);
	lcm_dcs_write_seq_static(ctx, 0x3F, 0x1B);
	lcm_dcs_write_seq_static(ctx, 0x40, 0x19);
	lcm_dcs_write_seq_static(ctx, 0x41, 0x17);
	lcm_dcs_write_seq_static(ctx, 0x42, 0x15);
	lcm_dcs_write_seq_static(ctx, 0x43, 0x13);
	lcm_dcs_write_seq_static(ctx, 0x44, 0x11);
	lcm_dcs_write_seq_static(ctx, 0x45, 0x21);
	lcm_dcs_write_seq_static(ctx, 0x46, 0x09);

	lcm_dcs_write_seq_static(ctx, 0x47, 0x07);
	lcm_dcs_write_seq_static(ctx, 0x48, 0x0C);
	lcm_dcs_write_seq_static(ctx, 0x49, 0x0E);
	...
	lcm_dcs_write_seq_static(ctx, 0x53, 0x1E);
	lcm_dcs_write_seq_static(ctx, 0x54, 0x1C);
	lcm_dcs_write_seq_static(ctx, 0x55, 0x1A);
	lcm_dcs_write_seq_static(ctx, 0x56, 0x18);
	lcm_dcs_write_seq_static(ctx, 0x57, 0x16);
	lcm_dcs_write_seq_static(ctx, 0x58, 0x14);
	lcm_dcs_write_seq_static(ctx, 0x59, 0x12);
	lcm_dcs_write_seq_static(ctx, 0x5A, 0x10);
	lcm_dcs_write_seq_static(ctx, 0x5B, 0x20);
	...
	lcm_dcs_write_seq_static(ctx, 0x69, 0x7E);
	lcm_dcs_write_seq_static(ctx, 0x6A, 0x7E);
	lcm_dcs_write_seq_static(ctx, 0x6D, 0xB5);
	lcm_dcs_write_seq_static(ctx, 0x73, 0xBB);
	...
	lcm_dcs_write_seq_static(ctx, 0xDC, 0x88);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x07);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xCB, 0xA6);
	lcm_dcs_write_seq_static(ctx, 0xCC, 0x98);
	lcm_dcs_write_seq_static(ctx, 0xCD, 0x89);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x7A);
	...
	lcm_dcs_write_seq_static(ctx, 0x9B, 0x86);
...
static const struct drm_display_mode default_mode = {
	.clock = 156376,
	.hdisplay = 720,
	.hsync_start = 720 + 146,//HFP
	.hsync_end = 720 + 146 + 4,//HSA
	.htotal = 720 + 146 + 4 + 4,//HBP
	.vdisplay = 1604,
	.vsync_start = 1604 + 350,/* 23703 90FPS */
	.vsync_end = 1604 + 350 + 4,//VSA
	.vtotal = 1604 + 350 + 4 + 30,//VBP
};
...
static const struct drm_display_mode performance_mode_50hz = {
	...
	.htotal = 720 + 146 + 4 + 4,//HBP
	.vdisplay = 1604,
	.vsync_start = 1604 + 1940,/* 23703 50FPS */
	.vsync_end = 1604 + 1940 + 4,//VSA
	.vtotal = 1604 + 1940 + 4 + 30,//VBP
};
...
static const struct drm_display_mode performance_mode_60hz = {
	...
	.htotal = 720 + 146 + 4 + 4,//HBP
	.vdisplay = 1604,
	.vsync_start = 1604 + 1340,/* 23703 60FPS */
	.vsync_end = 1604 + 1340 + 4,//VSA
	.vtotal = 1604 + 1340 + 4 + 30,//VBP
};
#endif
				 ...
				 unsigned int level)
{
	...
	if (level == 0) {
		pr_info("ili9883c_djn backlight diming off\n");
	...
	pr_info("ili9883c_djn backlight: bl_level=%d, level=%d, esd_last_level=%d\n",
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	/* wanhang */
	register_device_proc("lcd", "ili9883c", "djn_hjc");
	pr_info("%s- lcm,ili9883c_djn_hjc,vdo,90hz\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus23703_ili9883c_dj_hdp_dsi_vdo",
		.owner = THIS_MODULE,

...
#include "oplus22629_chengdu_data_hw_roundedpattern.h"
...
#define SILKY_MAX_NORMAL_BRIGHTNESS   16383
...
static struct LCM_setting_table lcm_set_HBM_again[] = {
	{REGFLAG_CMD,3, {0x51, 0x0f, 0xff}},
};
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	msleep(120);
	//Overdischarge VDDR
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x1C);
	jdi_dcs_write_seq_static(ctx,0x78,0x10);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x02);
	jdi_dcs_write_seq_static(ctx,0x0A,0x20);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x05);
	jdi_dcs_write_seq_static(ctx,0x01,0x50);
	/* ILI7838 SPR setting */
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x12);     // Page 0x12
	jdi_dcs_write_seq_static(ctx,0x20,0x26);
	jdi_dcs_write_seq_static(ctx,0x18,0x04);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x14);     // Page 0x14
	jdi_dcs_write_seq_static(ctx,0x00,0x01);
	jdi_dcs_write_seq_static(ctx,0x01,0x00);
	jdi_dcs_write_seq_static(ctx,0xb0,0xa0);
	jdi_dcs_write_seq_static(ctx,0x03,0x02);
	jdi_dcs_write_seq_static(ctx,0x04,0x28);
	jdi_dcs_write_seq_static(ctx,0x05,0x28);
	jdi_dcs_write_seq_static(ctx,0x06,0x05);
	jdi_dcs_write_seq_static(ctx,0x07,0x50);
	jdi_dcs_write_seq_static(ctx,0x08,0x05);
	jdi_dcs_write_seq_static(ctx,0x10,0x10,0x55,0x01,0x01,0x55,0x10,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x11,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x12,0x00,0x00,0x40,0x40,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x13,0x34,0x17,0x54,0x2a,0x75,0x3e,0x12,0x10);
	jdi_dcs_write_seq_static(ctx,0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x15,0x3e,0x75,0x2a,0x54,0x17,0x34,0x21,0x01);
	jdi_dcs_write_seq_static(ctx,0x16,0x00,0x00,0x80,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x17,0x36,0x07,0x4c,0x3d,0x7b,0x3a,0x32,0x00);
	jdi_dcs_write_seq_static(ctx,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x19,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1b,0x3a,0x7b,0x3d,0x4c,0x07,0x36,0x23,0x00);
	jdi_dcs_write_seq_static(ctx,0x1c,0x00,0x38,0x48,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1d,0x22);
	jdi_dcs_write_seq_static(ctx,0x1e,0x22);
	jdi_dcs_write_seq_static(ctx,0x1f,0x00);
	...
	jdi_dcs_write_seq_static(ctx,0x21,0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x80);
	jdi_dcs_write_seq_static(ctx,0x22,0x00,0x00,0x00,0x04,0x04,0x00,0x60,0x80);
	jdi_dcs_write_seq_static(ctx,0x23,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x80);
	jdi_dcs_write_seq_static(ctx,0x24,0x00,0x04,0x00,0x00,0x04,0x00,0x40,0x80);
	jdi_dcs_write_seq_static(ctx,0x25,0x18,0x00,0x00,0x24,0x00,0x00,0x46,0x5a);
	jdi_dcs_write_seq_static(ctx,0x26,0x18,0x00,0x00,0x24,0x00,0x00,0x1e,0x28);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x15);     // Page 0x15
	jdi_dcs_write_seq_static(ctx,0x01,0x01);
	jdi_dcs_write_seq_static(ctx,0x51,0x01);
	jdi_dcs_write_seq_static(ctx,0x52,0x94);
	jdi_dcs_write_seq_static(ctx,0x00,0x00,0x00,0x00,0x10,0x01,0x00,0x01,0x10,0x02,0x10,0x04,0x10,0x05,0x10,0x06,0x00,0x06,0x10,0x07,0x02,0x08,0x0d,0x09,0x1a,0x0b,0x0b,0x0e,0x19,0x12,0x19,0x17,0x09,0x1c,0x0c,0x21,0x1e,0x28,0x02,0x2e,0x17,0x35,0x1e,0x3d,0x1c,0x46,0x09,0x4f,0x06,0x58,0x18,0x6d,0x16,0x79,0x07,0x85,0x0d,0x9f,0x01,0xbb,0x0e,0xda,0x0c,0xfb,0x1d,0x00,0x0a);
	jdi_dcs_write_seq_static(ctx,0x50,0x00,0x00,0x10,0x00,0x14,0x00,0x18,0x00,0x1c,0x00,0x20,0x00,0x22,0x00,0x24,0x00,0x28,0x00,0x2c,0x00,0x30,0x02,0x31,0x00,0x34,0x03,0x39,0x0f,0x3f,0x01,0x43,0x0c,0x48,0x01,0x4f,0x0e,0x56,0x0d,0x5d,0x03,0x68,0x09,0x72,0x0a,0x7b,0x0b,0x84,0x01,0x93,0x02,0xa0,0x08,0xac,0x0a,0xb7,0x0e,0xcc,0x02,0xde,0x04,0xee,0x0b,0xfd,0x0f,0xff,0x0c);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x0E);     // Page 0x0E
	jdi_dcs_write_seq_static(ctx,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x01,0x00);
	jdi_dcs_write_seq_static(ctx,0x02,0x26);
	jdi_dcs_write_seq_static(ctx,0x03,0x00);
	jdi_dcs_write_seq_static(ctx,0x04,0xa4);
	jdi_dcs_write_seq_static(ctx,0x05,0x02);
	jdi_dcs_write_seq_static(ctx,0x06,0x16);
	jdi_dcs_write_seq_static(ctx,0x07,0x02);
	jdi_dcs_write_seq_static(ctx,0x08,0xa6);
	jdi_dcs_write_seq_static(ctx,0x09,0x05);
	jdi_dcs_write_seq_static(ctx,0x0a,0x66);
	jdi_dcs_write_seq_static(ctx,0x0b,0x11);
	jdi_dcs_write_seq_static(ctx,0x0c,0x23);
	jdi_dcs_write_seq_static(ctx,0x10,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x11,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x12,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x13,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x14,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x15,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x16,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x17,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x18,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x19,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1a,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1b,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1c,0x00,0x60,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1d,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1e,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x1f,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x20,0x08,0x10,0x18,0x20,0x28,0x30,0x38,0x40,0x48,0x50,0x58,0x60,0x68,0x70,0x78);
	jdi_dcs_write_seq_static(ctx,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x29,0x00,0x00,0x77,0x09,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x2a,0x0e,0x1a,0x1f,0x1c,0x11,0x06,0x51,0x00);
	jdi_dcs_write_seq_static(ctx,0x2b,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x2c,0x06,0x11,0x1c,0x1f,0x1a,0x0e,0x15,0x00);
	jdi_dcs_write_seq_static(ctx,0x2d,0x00,0x00,0x55,0x2b,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x2e,0x0b,0x17,0x1f,0x1d,0x14,0x09,0x32,0x00);
	jdi_dcs_write_seq_static(ctx,0x2f,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x30,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x31,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x32,0x09,0x14,0x1d,0x1f,0x1a,0x0b,0x23,0x00);
	jdi_dcs_write_seq_static(ctx,0x33,0x00,0x00,0x25,0x5b,0x00,0x00,0x00,0x00);
	...
	jdi_dcs_write_seq_static(ctx,0x40,0x00,0x00,0x00,0x00,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x48,0x10,0x00);
	jdi_dcs_write_seq_static(ctx,0x49,0x06,0x55);
	jdi_dcs_write_seq_static(ctx,0x4a,0x10,0x00);
	jdi_dcs_write_seq_static(ctx,0x4b,0x10,0x00);
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x15);     // Page 0x15
	jdi_dcs_write_seq_static(ctx,0x30,0x00);
	jdi_dcs_write_seq_static(ctx,0x31,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x32,0x77,0x09);
	jdi_dcs_write_seq_static(ctx,0x33,0x70,0x10);
	jdi_dcs_write_seq_static(ctx,0x34,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x35,0x10,0x70);
	jdi_dcs_write_seq_static(ctx,0x36,0x55,0x2b);
	jdi_dcs_write_seq_static(ctx,0x37,0x50,0x30);
	jdi_dcs_write_seq_static(ctx,0x38,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x39,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x3a,0x00,0x00);
	jdi_dcs_write_seq_static(ctx,0x3b,0x30,0x50);
	jdi_dcs_write_seq_static(ctx,0x3c,0x25,0x5b);
	/*finish ILI7838 SPR setting*/
	jdi_dcs_write_seq_static(ctx,0xFF,0x78,0x38,0x08);
...
#endif
        .vendor = "tianma_t7_plus_chengdu",
        .manufacture = "tianma_t7_plus",
	.lane_swap_en = 0,
		...
		void *handle, unsigned int hbm_mode)
{
	...
	pr_err("[lh]oplus_display_brightness= %d, hbm_mode=%u\n", oplus_display_brightness, hbm_mode);
			      ...
			      dcs_write_gce cb, void *handle, bool en)
{
	...
	pr_err("debug for oplus_display_brightness= %d, en=%u\n", oplus_display_brightness, en);
...
static int mode_switch(struct drm_panel *panel,struct drm_connector *connector,unsigned int cur_mode,
...
static int jdi_get_modes(struct drm_panel *panel, struct drm_connector *connector)
{
...
#endif
	register_device_proc("lcd", "tianma_t7_plus_chengdu", "tianma_t7_plus");
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "oplus22629_tianma_ili7838a_t7_plus_fhd_dsi_cmd_lcm_drv",
		.owner = THIS_MODULE,

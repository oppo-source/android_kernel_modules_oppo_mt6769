...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0xAF, 0x98);
    lcm_dcs_write_seq_static(ctx, 0x80, 0x37);
    lcm_dcs_write_seq_static(ctx, 0x81, 0x37);
    lcm_dcs_write_seq_static(ctx, 0x82, 0x37);
    ...
    lcm_dcs_write_seq_static(ctx, 0xB3, 0xF0);
    lcm_dcs_write_seq_static(ctx, 0xA6, 0xE6);
    lcm_dcs_write_seq_static(ctx, 0xAC, 0xFD);

    lcm_dcs_write_seq_static(ctx, 0xA7, 0xF9);
    lcm_dcs_write_seq_static(ctx, 0xAD, 0xE3);
    lcm_dcs_write_seq_static(ctx, 0x8C, 0xB0);
    lcm_dcs_write_seq_static(ctx, 0x8D, 0xB1);
    lcm_dcs_write_seq_static(ctx, 0x8E, 0xB2);
    lcm_dcs_write_seq_static(ctx, 0x8F, 0xB3);
    lcm_dcs_write_seq_static(ctx, 0x90, 0xB3);
    lcm_dcs_write_seq_static(ctx, 0x91, 0xBA);

    lcm_dcs_write_seq_static(ctx, 0x92, 0xCA);
    lcm_dcs_write_seq_static(ctx, 0x93, 0xCA);
    lcm_dcs_write_seq_static(ctx, 0x94, 0xCA);

    lcm_dcs_write_seq_static(ctx, 0x95, 0xDD);
    lcm_dcs_write_seq_static(ctx, 0xB4, 0xF0);

    lcm_dcs_write_seq_static(ctx, 0xA8, 0xE8);
    lcm_dcs_write_seq_static(ctx, 0xAB, 0xD0);
    lcm_dcs_write_seq_static(ctx, 0xAE, 0xF2);

    lcm_dcs_write_seq_static(ctx, 0x96, 0x50);
    lcm_dcs_write_seq_static(ctx, 0x97, 0x9C);
    ...
    lcm_dcs_write_seq_static(ctx, 0x9C, 0xD0);
    lcm_dcs_write_seq_static(ctx, 0x9D, 0xD0);
    lcm_dcs_write_seq_static(ctx, 0x9E, 0xD0);
    lcm_dcs_write_seq_static(ctx, 0x9F, 0xDF);
    lcm_dcs_write_seq_static(ctx, 0xB5, 0xF0);

    lcm_dcs_write_seq_static(ctx, 0xBD, 0x80);
    lcm_dcs_write_seq_static(ctx, 0xBE, 0x08);
    lcm_dcs_write_seq_static(ctx, 0xC1, 0xF4);
    lcm_dcs_write_seq_static(ctx, 0xA0, 0xC0);
    lcm_dcs_write_seq_static(ctx, 0xA1, 0x7E);
    lcm_dcs_write_seq_static(ctx, 0xA2, 0x4B);
    lcm_dcs_write_seq_static(ctx, 0xA3, 0xCF);
    lcm_dcs_write_seq_static(ctx, 0xA5, 0x69);
    lcm_dcs_write_seq_static(ctx, 0xB6, 0x50);
    lcm_dcs_write_seq_static(ctx, 0xB7, 0xD6);
    lcm_dcs_write_seq_static(ctx, 0xB8, 0xD5);
    lcm_dcs_write_seq_static(ctx, 0xB1, 0x66);
    lcm_dcs_write_seq_static(ctx, 0xB2, 0x10);
    lcm_dcs_write_seq_static(ctx, 0x86, 0x6C);
    lcm_dcs_write_seq_static(ctx, 0x87, 0x5C);
    ...
    lcm_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x06);
    usleep_range(200, 210);
    lcm_dcs_write_seq_static(ctx, 0x07, 0xF1);
...
static struct mtk_panel_params ext_params_45hz = {
    .vendor = "ili7807s_oris_c",
    .manufacture = "24700_tm_ili7807s",
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus24700_ili7807s_tm_fhdp_dsi_vdo",
		.owner = THIS_MODULE,
